...
voting_clade_model = load_model("voting_clf.pkl")
...
def generate_email(probability, input_dict, explanation, surname):
    ...
    Make sure to list out a set of incentives to stay based on their information, in bullet point format. Don't ever mention the probability of churning, your name or the machine learning model to the customer.
    """
...
if selected_customer_option:
    ...
    if st.button("Predict Churn"):
        ...
        email_content = generate_email(probability, input_dict, explanation, selected_surname)

        st.write("### Explanation:")
        st.write(explanation)
        st.write("### Email to Customer:")
